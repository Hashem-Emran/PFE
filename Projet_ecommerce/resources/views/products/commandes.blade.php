...
<div class="max-w-md mx-auto  md:max-w-2xl">
        ...
        <table class="table-auto mx-auto  text-sm text-left text-gray-500 dark:text-gray-400" style="text-align: justify">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th  scope="col" class="px-6 py-3">Name_User</th>
   ...
   <a href="{{route('annulercommande',[$f->commanderef])}}"
        class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><i  style="color: red;" class="fa fa-trash"></i></a></li>
</td>
                        </tr>
                    @endforeach
                @else
